    ...
    return (
        <div className="about">
            ...
            <h2 className="about__subtitle">Hey! </h2>
                ...
                After moving to Scotland with my girlfriend, I began working in a sawmill. A sawmill is not a place where there are opportunities for self-development. Self-development is very important to me so I felt something was missing.
                (Maybe - “I loved programming in high school, so I decided to try learning to program again.” I would leave out the stuff about struggling with imaginary numbers...)
                I started by learning Java and quickly realized that the back end is not what I would like to do. And so I started to get to know the front end. Learning the basics happened very quickly. I then started learning to React, how to work with APIs, and how to solve programming problems.</p>
                <h2 className="about__subtitle">Hold on. Are you working, do you have a child and are you still studying?</h2>
                <p className="about__me">Oh yes. I don't have much time to study because parenting plus work takes up most of my day. Some people relax by watching their favourite series on TV, others go to the gym, and me? I am programing and solve problems during writing code. Despite work and parenting, I still program every day for two hours. Sometimes I feel like I'm addicted to it.
